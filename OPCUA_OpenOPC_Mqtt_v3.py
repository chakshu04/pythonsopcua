#Starrt by making the OpenOPC library available to your application. This imports the OpenOPC.py module file located in the lib/site-packages/ directory.
import OpenOPC
import time
...
#opc.connect('Kepware.KEPServerEX.V6', '192.168.7.146')
...
#Device='Device1.'
#Tag='Temp'
Data=opc.read('Channel1.Device1.Temp')

print(type(Data))

broker="192.168.7.125"
port=1883
while True:
	def on_publish(client,userdata,result):             #create function for callback
    		print("data published \n")
	client1= paho.Client("connect1")                           #create client object
